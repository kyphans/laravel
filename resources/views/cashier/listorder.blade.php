...
@section('content')
    <div class="container_bill">
        <div class="d-flex text-center bd-highlight">
            <div class="py-1">
                <button class="btn btn-primary">Chờ thanh toán <span class="badge badge-light">5</span></button>
                <button class="btn btn-primary">Mang về <span class="badge badge-light">1</span></button>
                <button class="btn btn-primary">Chờ giao hàng <span class="badge badge-light">2</span></button>
                <button class="btn btn-primary">Đặt trước <span class="badge badge-light">0</span></button>
        ...
        <div class="bill_content">
            ...
            <table class="text-center table_bill table-bordered">
                <tr>
                    <th class="p-2 bg-warning text-white" colspan="4"><i class="float-left fas fa-tablets"> 1</i><i class="float-right fas fa-user"> 2</i></th>
                </tr>
                <tr>
